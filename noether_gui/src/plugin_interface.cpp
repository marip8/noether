...
namespace noether
{
std::string noether::MeshModifierWidgetPlugin::getSection() { return NOETHER_GUI_MESH_MODIFIER_SECTION; }
std::string noether::ToolPathPlannerWidgetPlugin::getSection() { return NOETHER_GUI_TPP_SECTION; }
std::string noether::DirectionGeneratorWidgetPlugin::getSection() { return NOETHER_GUI_DIRECTION_GENERATOR_SECTION; }
std::string noether::OriginGeneratorWidgetPlugin::getSection() { return NOETHER_GUI_ORIGIN_GENERATOR_SECTION; }
std::string noether::ToolPathModifierWidgetPlugin::getSection() { return NOETHER_GUI_TOOL_PATH_MODIFIER_SECTION; }
