...
#include "ui_collapsible_area_widget.h"
...
void CollapsibleArea::setContentLayout(QLayout* layout)
{
  ...
  const auto content_height = layout->sizeHint().height();
...
QLayout* CollapsibleArea::getContentLayout() const { return content->layout(); }
