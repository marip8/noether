...
EXPORT_ORIGIN_GENERATOR_PLUGIN(noether::Plugin_FixedOriginGeneratorWidget, FixedOriginGenerator)
EXPORT_ORIGIN_GENERATOR_PLUGIN(noether::Plugin_CentroidOriginGeneratorWidget, CentroidOriginGenerator)
EXPORT_ORIGIN_GENERATOR_PLUGIN(noether::Plugin_AABBOriginGeneratorWidget, AABBOriginGenerator)
